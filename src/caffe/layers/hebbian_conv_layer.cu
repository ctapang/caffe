...
namespace caffe {
	...
	void HebbianConvLayer<Dtype>::Add_feedback(const int size, const Dtype feedback_gain, const Dtype* feedback,
		Dtype* bottom) {
		caffe_gpu_axpy<Dtype>(size, feedback_gain, feedback, bottom);
	}
